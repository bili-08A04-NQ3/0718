package top.niqiu.core.Windows.layout;
...
public class VerticalFlowLayout extends FlowLayout
{
    ...
    {
        this(TOP, MIDDLE, 30, 0, 5, 5, true, false);
    }

    public VerticalFlowLayout(boolean isHorizontalFill, boolean isVerticalFill)
    {
        this(TOP, MIDDLE, 30, 0, 5, 5, isHorizontalFill, isVerticalFill);
    }

    public VerticalFlowLayout(int align)
    {
        this(align, MIDDLE, 30, 0, 5, 5, true, false);
    }

    public VerticalFlowLayout(int align, boolean isHorizontalFill, boolean isVerticalFill)
    {
        this(align, MIDDLE, 30, 0, 5, 5, isHorizontalFill, isVerticalFill);
    }

    public VerticalFlowLayout(int align, int horizontalGap, int verticalGap, boolean isHorizontalFill, boolean isVerticalFill)
    {
        this(align, MIDDLE, horizontalGap, verticalGap, verticalGap, verticalGap, isHorizontalFill, isVerticalFill);
    }

    public VerticalFlowLayout(int align, int horizontalGap, int verticalGap, int topVerticalGap, int bottomVerticalGap, boolean isHorizontalFill, boolean isVerticalFill)
    {
     ...
     */
    public VerticalFlowLayout(int verticalAlignment, int horizontalAlignment, int horizontalGap, int verticalGap, int topVerticalGap, int bottomVerticalGap, boolean isHorizontalFill, boolean isVerticalFill)
    {
